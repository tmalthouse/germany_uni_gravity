...
od_year.parquet -> output/tables/goettingen7_event_study.csv, output/figures/goettingen7_event_study.png
"""
...
def main() -> None:
    ...
    print('joint Wald pre-trends (1834-36):',
          joint_wald(fit, [f'got_y{y}' for y in years if y < TREAT_YEAR]))
    print('joint Wald post-1837 effects:',
          joint_wald(fit, [f'got_y{y}' for y in years if y > TREAT_YEAR]))
